              ...
              <div className="space-y-8">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[
                      { title: 'Zerodha vs Groww', desc: 'Discount Pioneer vs Modern Beginner App', id1: 'zerodha', id2: 'groww' },
                      { title: 'Dhan vs Angel One', desc: 'Super Trading Terminal vs Research & Advisory', id1: 'dhan', id2: 'angelone' },
                      { title: 'Upstox vs HDFC Sky', desc: 'Tata-Backed Tech Charts vs Bank-Grade Security', id1: 'upstox', id2: 'hdfcsky' }
                    ].map((comp, idx) => (
                      <button
                        key={idx}
                    ...
                    <div className="hidden lg:block space-y-6">
                      <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-5">
                        ...
                        <div className="space-y-2">
                          <label className="text-xs font-bold text-slate-400 uppercase tracking-wider">Annual Maintenance</label>
                          {[
                        ...
                        <div className="bg-slate-100 p-1 rounded-xl flex border border-slate-200/60">
                          <button
                            ...
                            className={`px-3 py-1.5 rounded-lg text-xs font-bold flex items-center gap-1 cursor-pointer ${
                              viewMode === 'table' ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-500'
                            }`}
                          >
                          ...
                          <button
                            ...
                            className={`px-3 py-1.5 rounded-lg text-xs font-bold flex items-center gap-1 cursor-pointer ${
                              viewMode === 'cards' ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-500'
                            }`}
                          >
                            <LayoutGrid size={13} />
                            Cards
                  ...
                  <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex justify-end">
                    <div className="w-full max-w-xs bg-white h-full p-6 shadow-2xl flex flex-col justify-between overflow-y-auto">
                      <div className="space-y-6">
                        ...
                        <button onClick={handleResetFilters} className="w-full py-2 border border-slate-200 text-slate-600 font-bold text-xs rounded-lg">
                          Reset Filters
                        </button>
                        <button onClick={() => setShowMobileFilters(false)} className="w-full py-2 bg-emerald-600 text-white font-bold text-xs rounded-lg">
                          Apply Filters
                        </button>
                      </div>
                    </div>
